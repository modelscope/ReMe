...
agent_wrapper_loader = ModuleLoader(
    class_path="experiencescope.module.agent_wrapper.naive_agent_wrapper",
...
context_generator_loader = ModuleLoader(
    class_path="experiencescope.module.context_generator.simple_context_generator",
...
summarizer_loader = ModuleLoader(
    class_path="experiencescope.module.summarizer.simple_summarizer",
    class_name="SimpleSummarizer",
    config_path="beyondagent/config/summarizer/simple_summarizer.json")

env_loader = ModuleLoader(
    class_path="experiencescope.module.environment.simple_environment",
